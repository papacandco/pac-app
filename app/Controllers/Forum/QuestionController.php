...
use App\Jobs\AnswerOfTheQuestionNotificationJob;
...
class QuestionController extends Controller
{
    ...
    /**
     * Show theTechnologie question comments
     *
     * @return mixed
     */
    public function __invoke(Request $request, string $slug, int $question_id)
    {
        $question = $this->question->where('slug', $slug)->where('id', $question_id)->firstOrFail();

        $question->load(['comments' => function ($query) {
        ...
        return view('forum.question', compact('curriculum', 'question', 'contributors'));
    }
    ...
    public function createResponse(Request $request, int $question_id)
    {
        ...
        dispatch(new AnswerOfTheQuestionNotificationJob($question, $comment));
