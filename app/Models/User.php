...
class User extends Model
{
     ...
     */
    protected $fillable = [
        'name', 'email', 'password', 'theme', 'pseudo', 'avatar', 'provider_id', 'provider_type', 'logged_at', 'country',
    ];
    ...
    public function hasSubscribe(Product $product)
    {
        $subsciption = $this->subscriptions()
            ->whereProductId($product->product_id)
    ...
    public function tutorialBookmarks()
    {
        ...
        $results = $this->hasMany(Bookmark::class, 'user_id')
            ...
            ->whereBookmarkableType(Tutorial::class)
    ...
    public function curriculumBookmarks()
    {
        ...
        $results = $this->hasMany(Bookmark::class, 'user_id')
            ...
            ->whereBookmarkableType(Curriculum::class)
            ->orderBy('bookmarked_at', 'desc')
    ...
    public function questionBookmarks()
    {
        ...
        $results = $this->hasMany(Bookmark::class, 'user_id')
            ...
            ->whereBookmarkableType(Question::class)
    ...
    public function podcastBookmarks()
    {
        ...
        $results = $this->hasMany(Bookmark::class, 'user_id')
            ...
            ->whereBookmarkableType(Podcast::class)
