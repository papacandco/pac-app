  ...
  <div class="media shadow-sm rounded" style="padding: 5px;" style="border: unset">
    <div class="media-left">
      <div class="media-object" style="padding: 5px;">
        <i class="fa fa-play text-{{ auth()->check() && $followed && $tutorial->hasProgress(auth()->user(), $curriculum->id) ? "success" : "white" }}"></i>
    ...
    <div class="media-body">
      ...
      <strong style="position: relative; top: 5px;">
        <a href="{{ route('tutorial.reader', ['slug' => $tutorial->slug, 'id' => $tutorial->id]) }}#pager-{{ $tutorial->id }}">
          {{ $tutorial->title }}
        </a>
      </strong>
...
<div class="visible-xs" style="margin-top: 2px; margin-bottom: 20px; margin-right: 7px; border-left: 4px solid #144571">
  <div class="media shadow-sm rounded" style="padding: 5px;">
    <div class="media-body">
      <strong style="position: relative; top: 5px;">
        <a href="{{ route('tutorial.reader', ['slug' => $tutorial->slug, 'id' => $tutorial->id]) }}#pager-{{ $tutorial->id }}">{{ $tutorial->title }}</a>
      </strong>
