...
use App\Jobs\NotificationCurriculumFollowersForTheQuestionCreationJob;
...
class ForumController extends Controller
{
    ...
    public function __invoke(Request $request)
    {
        ...
        $questions = $this->question->withFlash('curriculum')
    ...
    public function createQuestion(
        ...
        if (! is_null($curriculum)) {
            ...
            dispatch(new NotificationCurriculumFollowersForTheQuestionCreationJob(
                $curriculum,
                $question
            ));
        }
