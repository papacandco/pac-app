    ...
    <div class="container" style="padding: 20px; max-width: 1200px;">
      <div class="row">
            ...
            {{-- <div class="col-sm-6">
              <div style="margin-top: 2px; margin-bottom: 20px; margin-right: 7px">
                <div class="media" style="padding: 5px; border: unset; background: inherit !important;">
                  <div class="media-left">
                    <div class="media-object" style="padding: 5px;">
                      <img src="{{ __('about.author.persons.1.avatar') }}" class="img-circle" alt="Photo Salomon DION" style="width: 50px; height: 50px; background-color: #eee">
                    </div>
                  </div>
                  <div class="media-body">
                    <p>
                      {!! __('about.author.persons.1.description') !!}
                    </p>
                  </div>
                </div>
              </div>
        ...
        <div class="col-sm-3 col-xs-12">
          ...
          <ul>
            <li>
              <a style="color: inherit;" href="mailto:contact@codelearningclub.com">
                {{ __('footer.contact_by_email') }}
              </a>
            </li>
            <li>
              <a style="color: inherit;" href="https://layout.org">
                {{ __('footer.blog') }}
              </a>
            </li>
            <li>
