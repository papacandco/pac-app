...
<meta name="dcterms.Language" content="{{ config('translate.lang') }}">
<meta name="dcterms.Identifier" content="{{ request()->url() }}">
<meta name="dcterms.Relation" content="{{ config('app.name') }}">
<meta name="dcterms.Publisher" content="{{ config('app.name') }}">
<meta name="dcterms.Type" content="text/html">
<meta name="dcterms.Coverage" content="{{ request()->url() }}">
...
<!-- Facebook OpenGraph -->
<meta property="og:locale" content="{{ config('translate.lang') }}">
