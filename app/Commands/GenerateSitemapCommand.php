...
class GenerateSitemapCommand extends ConsoleCommand
{
    /**
     * Sitemap instance
     *
    ...
    public function process()
    {
        ...
        $this->generateTechnologieSitemap();
     ...
     * @return void
     */
    private function generateTechnologieSitemap()
    {
        $this->sitemap = Sitemap::create();
    ...
    private function generateForumSitemap()
    {
        ...
        $forums = Technologie::where('with_forum', 1)->get();

        foreach ($forums as $forum) {
            $route = route('forum.single', [
                'slug' => $forum->slug,
                'id' => $forum->id,
                'type' => 'technologie',
            ]);
    ...
    {
        $tutorials = Tutorial::wherePublished(true)->get();
